...
?>
			<div class="wrap">
				...
				<div>	
					...
					<br />
					<h3>IMPORTANT:</h3>
					Reservations will be made with 50% of the total amount of the stay until August 31st, 2015 by transfer / deposit to the bank account or using Paypal, and the remaining 50% until November 16st, 2015.
					<br />
