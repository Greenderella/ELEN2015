...
(function(q,r,m){var s={required:"El campo de %s es requerido.",matches:"El campo %s no coincide con el campo %s.","default":"El campo %s quedó en el estado por defecto, por favor cambielo.",valid_email:"El campo %s debe contener una dirección de E-Mail valida.",valid_emails:"El campo %s debe contener todas direcciones de E-Mail validas.",min_length:"El campo %s debe ser de al menos %s caracteres en tamaño.",max_length:"El campo %s no debe exceder los %s caracteres en tamaño.",exact_length:"El campo %s debe tener exactamente %s caracteres en tamaño.",
greater_than:"El campo %s debe contener un numero mayor a %s.",less_than:"El campo %s debe contener un numero menor a %s..",alpha:"El campo %s debe contener solamente letras.",alpha_numeric:"El campo %s debe contener solo letras y números.",alpha_dash:"El campo %s debe contener solo letras, números, barras bajas o medias.",numeric:"El campo %s debe contener solo numeros.",integer:"El campo %s debe contener solo números enteros.",decimal:"El campo %s debe contener solo números decimales.",
is_natural:"El campo %s debe contener solo números positivos.",is_natural_no_zero:"El campo %s debe contener solo números mayores a cero.",valid_ip:"El campo %s debe contener una dirección de IP valida.",valid_base64:"El campo %s debe contener una cadena en base 64 valida.",valid_credit_card:"El campo %s debe contener un numero de tarjeta de credito valida",is_file_type:"El campo %s debe contener archivos solamente del tipo %s.",valid_url:"El campo %s debe contener una dirección URL valida"},t=function(a){},u=/^(.+?)\[(.+)\]$/,h=/^[0-9]+$/,v=/^\-?[0-9]+$/,k=/^\-?[0-9]*\.?[0-9]+$/,
